...
<template>
  <div class="bg-surface min-h-screen">
    ...
    <div class="container mx-auto px-4 relative z-20 -mt-8 mb-24">
                    ...
                    <h3 class="font-serif text-xl font-bold text-primary mb-4 flex items-center gap-2">
                     ...
                     <ul class="space-y-2 text-base text-gray-300 font-mono">
                        <li class="flex justify-between">
                            ...
                            <span class="text-white font-bold">8:00 - 17:30</span>
                        </li>
                        <li class="flex justify-between">
                            <span>{{ t('contact_view.days.saturday') }}</span>
                            <span class="text-white font-bold">8:00 - 12:00</span>
                        </li>
                         <li class="flex justify-between text-red-400">
                            <span>{{ t('contact_view.days.sunday') }}</span>
                            <span class="font-bold">{{ t('contact_view.days.closed') }}</span>
                        </li>
                    </ul>
                </div>
            </div>

            <!-- RIGHT COLUMN: Form Area (Col-span-7) -->
            <div class="lg:col-span-7 p-12 lg:p-20 bg-white relative">
